...
<div class="col-lg-9">
  ...
  <div class="panel-heading"><h4><b><a href="addreport.php">Add Internet Service Downtime Report</a></b></h4></div>
  <div class="panel-heading"><h4><b>Internet Downtime Reports</b></h4></div>
    <div class="panel-body">
      <div class="col-lg-12">
        ...
        $query = "SELECT reportid, Date, Time, Description FROM reports where UserID='$qid'";
